                        ...
                        <Item style={styles.justifyItem}>
                            ...
                            <Item style={styles.input}>
                                ...
                                <Item regular>
                                    ...
                                    <Input placeholder='Enter a password' onChangeText={(password) => onChangePassword(password)}
                            ...
                            <Item style={styles.input}>
                                ...
                                <Item regular>
                                    ...
                                    value={c_password}
                                    secureTextEntry={true} /> */}
                                    <Input placeholder='Confirm your password' onChangeText={(c_password) => onChangeConfirmPassword(c_password)}
                                        placeholderTextColor={WHITE}
                                        value={c_password}
